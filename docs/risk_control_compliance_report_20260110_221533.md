...
**检查时间**: 2026-01-10T22:15:32.863226
...
- **文件**: web-static/risk-control-monitor.html
- **状态**: passed
- **消息**: 流程步骤状态显示（6个步骤的状态和性能指标）: 找到 45/6 个必需模式
- **匹配情况**: 45/6
...
- **状态**: passed
- **消息**: WebSocket端点注册（/ws/risk-control）: 找到 2/1 个必需模式
- **匹配情况**: 2/1
...
- **状态**: passed
- **消息**: 风险控制WebSocket广播实现: 找到 9/2 个必需模式
- **匹配情况**: 9/2
...
- **文件**: web-static/risk-control-monitor.html
- **状态**: passed
- **消息**: 前端WebSocket消息处理（/ws/risk-control）: 找到 12/2 个必需模式
- **匹配情况**: 12/2
...
```json
{
  "timestamp": "2026-01-10T22:15:32.863226",
  "frontend_modules": {
    "dashboard_exists": {
    ...
    "step_status_display": {
      "status": "passed",
      "message": "流程步骤状态显示（6个步骤的状态和性能指标）: 找到 45/6 个必需模式",
      "found_patterns": [
        [
  ...
  "websocket_integration": {
    "websocket_endpoint": {
      "status": "passed",
      "message": "WebSocket端点注册（/ws/risk-control）: 找到 2/1 个必需模式",
      "found_patterns": [
        [
    ...
    "websocket_manager": {
      "status": "passed",
      "message": "风险控制WebSocket广播实现: 找到 9/2 个必需模式",
      "found_patterns": [
        [
    ...
    "frontend_websocket": {
      "status": "passed",
      "message": "前端WebSocket消息处理（/ws/risk-control）: 找到 12/2 个必需模式",
      "found_patterns": [
        [
