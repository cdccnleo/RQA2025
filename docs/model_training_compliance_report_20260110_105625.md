...
**检查时间**: 2026-01-10T10:56:25.411885
...
- **文件**: N/A
- **状态**: passed
- **消息**: 特征层适配器使用（通过统一适配器工厂）: 找到 26/1 个必需模式
- **匹配情况**: 26/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 通过统一适配器工厂访问特征层: 找到 41/1 个必需模式
- **匹配情况**: 41/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 特征层适配器使用（特征数据流处理）: 找到 45/2 个必需模式
- **匹配情况**: 45/2
...
- **文件**: N/A
- **状态**: passed
- **消息**: 数据流处理（特征层到ML层）: 找到 39/2 个必需模式
- **匹配情况**: 39/2
...
```json
{
  "timestamp": "2026-01-10T10:56:25.411885",
  "frontend_modules": {
    "dashboard_exists": {
  ...
  "architecture_compliance": {
    ...
    "ml_layer_access": {
      "status": "passed",
      "message": "机器学习层组件访问: 找到 24/1 个必需模式",
      "found_patterns": [
        [
          "MLCore|模型训练器|ML层组件",
          24
    ...
    "features_layer_adapter_usage": {
      "status": "passed",
      "message": "特征层适配器使用（通过统一适配器工厂）: 找到 26/1 个必需模式",
      "found_patterns": [
        [
  ...
  "data_flow_integration": {
    "adapter_factory_features_access": {
      "status": "passed",
      "message": "通过统一适配器工厂访问特征层: 找到 41/1 个必需模式",
      "found_patterns": [
        [
    ...
    "features_layer_adapter": {
      "status": "passed",
      "message": "特征层适配器使用（特征数据流处理）: 找到 45/2 个必需模式",
      "found_patterns": [
        [
    ...
    "data_flow_processing": {
      "status": "passed",
      "message": "数据流处理（特征层到ML层）: 找到 39/2 个必需模式",
      "found_patterns": [
        [
