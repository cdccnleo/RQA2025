...
**检查时间**: 2026-01-10T10:52:59.027350
...
- **文件**: N/A
- **状态**: passed
- **消息**: 特征层适配器使用（通过统一适配器工厂）: 找到 16/1 个必需模式
- **匹配情况**: 16/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 特征层适配器使用（特征数据流处理）: 找到 30/1 个必需模式
- **匹配情况**: 30/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 数据流处理（特征层到ML层）: 找到 22/1 个必需模式
- **匹配情况**: 22/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: BusinessProcessOrchestrator使用: 找到 25/1 个必需模式
- **匹配情况**: 25/1
...
```json
{
  "timestamp": "2026-01-10T10:52:59.027350",
  "frontend_modules": {
    "dashboard_exists": {
  ...
  "architecture_compliance": {
    ...
    "features_layer_adapter_usage": {
      "status": "passed",
      "message": "特征层适配器使用（通过统一适配器工厂）: 找到 16/1 个必需模式",
      "found_patterns": [
        [
  ...
  "data_flow_integration": {
    ...
    "features_layer_adapter": {
      "status": "passed",
      "message": "特征层适配器使用（特征数据流处理）: 找到 30/1 个必需模式",
      "found_patterns": [
        [
    ...
    "data_flow_processing": {
      "status": "passed",
      "message": "数据流处理（特征层到ML层）: 找到 22/1 个必需模式",
      "found_patterns": [
        [
  ...
  "business_orchestration": {
    "orchestrator_usage": {
      "status": "passed",
      "message": "BusinessProcessOrchestrator使用: 找到 25/1 个必需模式",
      "found_patterns": [
        [
          "BusinessProcessOrchestrator|orchestrator|业务流程",
          25
