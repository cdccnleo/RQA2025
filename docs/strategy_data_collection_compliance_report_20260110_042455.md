...
**检查时间**: 2026-01-10T04:24:55.760566
...
### infrastructure_logging ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: 基础设施层日志集成: 部分模式找到 (1/2)

### event_bus_integration ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: 事件总线集成: 部分模式找到 (2/3)
...
- **文件**: N/A
- **状态**: warning
- **消息**: 适配器模式使用: 部分模式找到 (1/3)

## 📝 详细检查结果

```json
{
  "timestamp": "2026-01-10T04:24:55.760566",
  "dashboard_checks": {
    "core_dashboard_file": {
