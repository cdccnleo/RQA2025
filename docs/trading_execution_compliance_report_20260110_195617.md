...
**检查时间**: 2026-01-10T19:56:17.626375
...
### persistence_integration ⚠️

- **文件**: src/gateway/web/trading_execution_service.py
- **状态**: warning
- **消息**: 持久化集成: 仅找到 0/1 个必需模式
- **匹配情况**: 0/1
...
```json
{
  "timestamp": "2026-01-10T19:56:17.626375",
  "frontend_modules": {
    "dashboard_exists": {
  ...
  "service_layer": {
    ...
    "persistence_integration": {
      "status": "warning",
      "message": "持久化集成: 仅找到 0/1 个必需模式",
      "found_patterns": [],
      "missing_patterns": [
        "trading_execution_persistence|save_execution_record|持久化存储"
      ],
      "found_count": 0,
      "required_count": 1,
      "file": "src/gateway/web/trading_execution_service.py"
