...
**复核时间**: 2026-01-10T08:09:22.887361
...
### unified_config_integration ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: UnifiedConfigManager集成: 仅找到 0/1 个必需模式
- **匹配情况**: 0/1
...
### quality_monitor_integration ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: 数据质量监控API集成: 仅找到 0/1 个必需模式
- **匹配情况**: 0/1
...
### performance_monitor_integration ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: 数据性能监控API集成: 仅找到 0/1 个必需模式
- **匹配情况**: 0/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: UnifiedConfigManager使用: 找到 4/1 个必需模式
- **匹配情况**: 4/1
...
### event_bus_config_changes ⚠️

- **文件**: N/A
- **状态**: warning
- **消息**: 数据源配置变更事件发布: 仅找到 0/1 个必需模式
- **匹配情况**: 0/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 数据采集状态WebSocket推送: 找到 2/1 个必需模式
- **匹配情况**: 2/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: PostgreSQL持久化: 找到 21/1 个必需模式
- **匹配情况**: 21/1
...
```json
{
  "timestamp": "2026-01-10T08:09:22.887361",
  "frontend_modules": {
    "data_sources_config_dashboard": {
  ...
  "backend_apis": {
    ...
    "unified_config_integration": {
      "status": "warning",
      "message": "UnifiedConfigManager集成: 仅找到 0/1 个必需模式",
      "found_patterns": [],
      "missing_patterns": [
    ...
    "quality_monitor_integration": {
      "status": "warning",
      "message": "数据质量监控API集成: 仅找到 0/1 个必需模式",
      "found_patterns": [],
      "missing_patterns": [
        "/api/v1/data/quality/metrics",
        "UnifiedQualityMonitor|quality_monitor"
      ],
      "found_count": 0,
      "required_count": 1
    },
    ...
    "performance_monitor_integration": {
      "status": "warning",
      "message": "数据性能监控API集成: 仅找到 0/1 个必需模式",
      "found_patterns": [],
      "missing_patterns": [
  ...
  "architecture_compliance": {
    "unified_config_usage": {
      "status": "passed",
      "message": "UnifiedConfigManager使用: 找到 4/1 个必需模式",
      "found_patterns": [
        [
          "UnifiedConfigManager",
          4
    ...
    "event_bus_config_changes": {
      "status": "warning",
      "message": "数据源配置变更事件发布: 仅找到 0/1 个必需模式",
      "found_patterns": [],
      "missing_patterns": [
  ...
  "websocket_integration": {
    ...
    "collection_status_websocket": {
      "status": "passed",
      "message": "数据采集状态WebSocket推送: 找到 2/1 个必需模式",
      "found_patterns": [
        [
          "data_collection_started|data_collection_completed|data_collection_failed",
          1
        ],
        [
          "websocket_manager\\.broadcast|WebSocket.*broadcast",
  ...
  "persistence": {
    ...
    "postgresql_persistence": {
      "status": "passed",
      "message": "PostgreSQL持久化: 找到 21/1 个必需模式",
      "found_patterns": [
        [
