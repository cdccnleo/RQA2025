...
**检查时间**: 2026-01-10T10:21:03.643172
...
- **文件**: N/A
- **状态**: passed
- **消息**: 数据层适配器使用（通过统一适配器工厂）: 找到 15/1 个必需模式
- **匹配情况**: 15/1
...
- **文件**: N/A
- **状态**: passed
- **消息**: 通过统一适配器工厂访问数据层: 找到 23/1 个必需模式
- **匹配情况**: 23/1
...
```json
{
  "timestamp": "2026-01-10T10:21:03.643172",
  "frontend_modules": {
    "dashboard_exists": {
  ...
  "architecture_compliance": {
    ...
    "data_layer_adapter_usage": {
      "status": "passed",
      "message": "数据层适配器使用（通过统一适配器工厂）: 找到 15/1 个必需模式",
      "found_patterns": [
        [
  ...
  "data_flow_integration": {
    "adapter_factory_data_access": {
      "status": "passed",
      "message": "通过统一适配器工厂访问数据层: 找到 23/1 个必需模式",
      "found_patterns": [
        [
