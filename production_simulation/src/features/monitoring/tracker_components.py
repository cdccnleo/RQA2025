...
class TrackerComponentFactory:
    ...
    # 支持的tracker ID列表
    SUPPORTED_TRACKER_IDS = [2, 7, 12, 17, 22]
...
def create_tracker_tracker_component_2(): return TrackerComponentFactory.create_component(2)


def create_tracker_tracker_component_7(): return TrackerComponentFactory.create_component(7)


def create_tracker_tracker_component_12(): return TrackerComponentFactory.create_component(12)


def create_tracker_tracker_component_17(): return TrackerComponentFactory.create_component(17)


def create_tracker_tracker_component_22(): return TrackerComponentFactory.create_component(22)
