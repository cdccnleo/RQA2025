...
class OptimizationComponentFactory:
    ...
    SUPPORTED_OPTIMIZATION_IDS = [5, 10, 15, 20, 25]
...
def create_optimization_optimization_component_5(): return OptimizationComponentFactory.create_component(5)


def create_optimization_optimization_component_10(
): return OptimizationComponentFactory.create_component(10)


def create_optimization_optimization_component_15(
): return OptimizationComponentFactory.create_component(15)


def create_optimization_optimization_component_20(
): return OptimizationComponentFactory.create_component(20)


def create_optimization_optimization_component_25(
): return OptimizationComponentFactory.create_component(25)
...
__all__ = [
    ...
    "create_optimization_optimization_component_5",
    "create_optimization_optimization_component_10",
    "create_optimization_optimization_component_15",
    "create_optimization_optimization_component_20",
    "create_optimization_optimization_component_25",
]
