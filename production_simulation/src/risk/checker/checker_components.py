...
class CheckerComponentFactory:
    ...
    def get_factory_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "description": f"统一Checker组件工厂，替代原有的{len(CheckerComponentFactory.SUPPORTED_CHECKER_IDS)}个模板化文件"
        }

# 向后兼容：创建旧的组件实例
def create_checker_checker_component_1():
    return CheckerComponentFactory.create_component(1)


def create_checker_checker_component_6():
    return CheckerComponentFactory.create_component(6)


def create_checker_checker_component_11():
    return CheckerComponentFactory.create_component(11)
...
__all__ = [
    ...
    "create_checker_checker_component_1",
    "create_checker_checker_component_6",
    "create_checker_checker_component_11",
]
