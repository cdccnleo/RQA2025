...
class MonitorComponentFactory:
    ...
    def get_factory_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "description": f"统一Monitor组件工厂，替代原有的{len(MonitorComponentFactory.SUPPORTED_MONITOR_IDS)}个模板化文件"
        }

    # 向后兼容：创建旧的组件实例
    def create_monitor_monitor_component_1():
        return MonitorComponentFactory.create_component(1)

    def create_monitor_monitor_component_6():
        return MonitorComponentFactory.create_component(6)
