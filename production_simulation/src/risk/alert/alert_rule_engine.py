...
from .realtime_risk_monitor import RiskType
...
class ConditionType(Enum):
    ...
    """条件类型枚举"""
    THRESHOLD = "threshold"           # 阈值条误    TREND = "trend"                   # 趋势条件
...
class Operator(Enum):
    ...
    LE = "<="                         # 小于等于
    EQ = "=="                         # 等于
    # 不等误    IN = "in"                         # 误..误    NOT_IN = "not_in"                 # 不在...误    CONTAINS = "contains"             # 包含
    NE = "!="
    # 不包误    REGEX = "regex"                   # 正则表达误    STARTS_WITH = "starts_with"       # 误..开误    ENDS_WITH = "ends_with"           # 误..结束
