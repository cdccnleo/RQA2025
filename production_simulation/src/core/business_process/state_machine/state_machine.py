...
from src.core.constants import (
    SECONDS_PER_MINUTE, DEFAULT_TIMEOUT, DEFAULT_TEST_TIMEOUT
)
...
class BusinessProcessStateMachine:
    ...
    def _initialize_state_timeouts(self) -> None:
        ...
        default_timeouts = {
            BusinessProcessState.DATA_COLLECTING: SECONDS_PER_MINUTE,      # 1分钟
            BusinessProcessState.DATA_QUALITY_CHECKING: DEFAULT_TIMEOUT,  # 30秒
            BusinessProcessState.FEATURE_EXTRACTING: 120,   # 2分钟
            BusinessProcessState.GPU_ACCELERATING: DEFAULT_TEST_TIMEOUT,     # 5分钟
            BusinessProcessState.MODEL_PREDICTING: 180,     # 3分钟
            BusinessProcessState.MODEL_ENSEMBLING: SECONDS_PER_MINUTE,      # 1分钟
            BusinessProcessState.SIGNAL_GENERATING: DEFAULT_TIMEOUT,     # 30秒
            BusinessProcessState.STRATEGY_DECIDING: SECONDS_PER_MINUTE,     # 1分钟
            BusinessProcessState.RISK_CHECKING: 45,         # 45秒
            BusinessProcessState.ORDER_GENERATING: DEFAULT_TIMEOUT,      # 30秒
            BusinessProcessState.ORDER_ROUTING: 15,         # 15秒
            BusinessProcessState.EXECUTING: 120,            # 2分钟
            BusinessProcessState.MONITORING: DEFAULT_TEST_TIMEOUT,           # 5分钟
        }
    ...
    def check_state_timeout(self, current_state: BusinessProcessState) -> bool:
        ...
        timeout_seconds = self.state_timeouts.get(current_state, DEFAULT_TEST_TIMEOUT)  # 默认5分钟
