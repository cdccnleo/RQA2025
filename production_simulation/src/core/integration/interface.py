...
# 优先从新的接口模块导入实现，保持向后兼容
try:
    from .interfaces.interface import (
        ICoreComponentCompat,
        SystemLayerInterfaceManager,
        SystemIntegrationManager,
        ICoreComponent as _NewICoreComponent,
    )

    ICoreComponent = _NewICoreComponent
