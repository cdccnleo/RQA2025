...
迁移示例：
    # 旧方式
    from src.core.integration.adapters.trading_adapter import TradingAdapter
    
    # 新方式（推荐）
    from src.core.integration.adapters.refactored_adapters import UnifiedTradingAdapter
