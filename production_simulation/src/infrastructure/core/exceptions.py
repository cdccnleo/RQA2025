...
class CacheError(InfrastructureException):
    ...
    def __init__(self, message: str, cache_key: str = None):
        super().__init__(f"缓存错误 - {cache_key}: {message}")
...
class LoggingError(InfrastructureException):
    ...
    def __init__(self, message: str, log_file: str = None):
        super().__init__(f"日志错误 - {log_file}: {message}")
...
class MonitoringError(InfrastructureException):
    ...
    def __init__(self, message: str, metric_name: str = None):
        super().__init__(f"监控错误 - {metric_name}: {message}")
...
class ResourceError(InfrastructureException):
    ...
    def __init__(self, message: str, resource_type: str = None):
        super().__init__(f"资源错误 - {resource_type}: {message}")
...
class NetworkError(InfrastructureException):
    ...
    def __init__(self, message: str, endpoint: str = None):
        super().__init__(f"网络错误 - {endpoint}: {message}")
...
class DatabaseError(InfrastructureException):
    ...
    def __init__(self, message: str, table_name: str = None):
        super().__init__(f"数据库错误 - {table_name}: {message}")
