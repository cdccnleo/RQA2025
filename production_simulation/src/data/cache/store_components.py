...
class StoreComponentFactory:
    ...
    # 支持的store ID列表
    SUPPORTED_STORE_IDS = [3, 7, 11, 15, 19, 23]
...
def create_store_store_component_3(): return StoreComponentFactory.create_component(3)


def create_store_store_component_7(): return StoreComponentFactory.create_component(7)


def create_store_store_component_11(): return StoreComponentFactory.create_component(11)


def create_store_store_component_15(): return StoreComponentFactory.create_component(15)


def create_store_store_component_19(): return StoreComponentFactory.create_component(19)


def create_store_store_component_23(): return StoreComponentFactory.create_component(23)
