...
### 执行引擎相关（3个）
- `test_execution_engine_advanced.py::TestExecutionEngineCoreFunctionality::test_cancel_execution_detailed`
- `test_execution_engine_deep_coverage.py::TestExecutionEngineDeepCoverage::test_market_impact_minimization`
- `test_execution_engine_deep_coverage.py::TestExecutionEngineDeepCoverage::test_execution_error_handling_and_recovery`
- `test_execution_engine_deep_coverage.py::TestExecutionEngineDeepCoverage::test_execution_cost_optimization`

### 交易补充测试相关（7个）
- `test_trading_deep_supplement.py::TestComplexOrderTypes::test_vwap_order`
