...
根据最新测试结果，还有6个失败的测试用例需要修复：
- `test_check_t1_restriction` - T+2断言错误
- `test_calculate_fees_non_a_stock` - 需要查看
- `test_calculate_fees_edge_cases` - 需要查看
- `test_multi_market_concurrent_trading.py` 相关测试（3个）
...
**当前状态**: ✅ 已修复27个失败的测试用例，测试通过率从97.8%提升到99.5%（1114通过，6失败），覆盖率从44%提升到49%。
