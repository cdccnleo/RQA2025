...
class StrategyOptimizer:
    ...
    def set_parameter_ranges(self, parameter_ranges: Dict[str, Any]) -> None:
        """设置参数范围
    ...
    def optimize_with_constraints(self, evaluate_func: callable,
        ...
        if method == 'random_search':
            ...
            for _ in range(n_iterations):
                ...
                # 检查约束
                if all(constraint_func(params) for constraint_func in self.constraints.values()):
