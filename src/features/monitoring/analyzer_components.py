...
class AnalyzerComponentFactory:
    ...
    # 支持的analyzer ID列表
    SUPPORTED_ANALYZER_IDS = [3, 8, 13, 18, 23]
...
def create_analyzer_analyzer_component_3(): return AnalyzerComponentFactory.create_component(3)


def create_analyzer_analyzer_component_8(): return AnalyzerComponentFactory.create_component(8)


def create_analyzer_analyzer_component_13(): return AnalyzerComponentFactory.create_component(13)


def create_analyzer_analyzer_component_18(): return AnalyzerComponentFactory.create_component(18)


def create_analyzer_analyzer_component_23(): return AnalyzerComponentFactory.create_component(23)
