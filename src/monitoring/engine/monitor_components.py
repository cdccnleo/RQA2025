...
def create_monitor_monitor_component_2(): return MonitorComponentFactory.create_component(2)


def create_monitor_monitor_component_7(): return MonitorComponentFactory.create_component(7)
