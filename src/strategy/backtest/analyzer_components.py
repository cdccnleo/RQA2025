...
def create_analyzer_analyzer_component_2(): return AnalyzerComponentFactory.create_component(2)


def create_analyzer_analyzer_component_7(): return AnalyzerComponentFactory.create_component(7)


def create_analyzer_analyzer_component_12(): return AnalyzerComponentFactory.create_component(12)
...
__all__ = [
    ...
    "create_analyzer_analyzer_component_2",
    "create_analyzer_analyzer_component_7",
    "create_analyzer_analyzer_component_12",
]
