...
class ChinaMarketStrategy(bt.Strategy):
    ...
    def _check_price_limit(self) -> bool:
        """检查涨跌停限制"""
        from src.trading.risk.china.price_limit import get_price_limits
    ...
    def _check_star_market_rules(self) -> bool:
        """检查科创板特殊规则"""
        from src.trading.risk.china.star_market import is_star_market_stock
        from src.trading.risk.china.star_market import check_star_market_rules
