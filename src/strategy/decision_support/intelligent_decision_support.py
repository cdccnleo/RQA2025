...
try:
    ...
    DASH_BOOTSTRAP_AVAILABLE = True
except ImportError:
    DASH_BOOTSTRAP_AVAILABLE = False
    # 创建一个mock的dbc对象
    class MockDBC:
...
from core.core_optimization.monitoring.deep_learning_predictor import get_deep_learning_predictor
from ..intelligence.multi_strategy_optimizer import get_strategy_engine
