...
try:
    ...
    def get_data_integration_manager() -> Any:
        ...
        if _data_adapter is None:
            try:
                from src.infrastructure.integration.data.data_adapter import get_data_layer_adapter as real_get_data_layer_adapter
                _data_adapter = real_get_data_layer_adapter()
            except ImportError:
                _data_adapter = None
