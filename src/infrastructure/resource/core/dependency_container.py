...
try:
    ...
    print(f"DEBUG: Successfully imported InfrastructureException: {InfrastructureException}")
except ImportError as e:
    print(f"DEBUG: Failed to import InfrastructureException: {e}")
    InfrastructureException = Exception


class DependencyResolutionError(InfrastructureException):
    """依赖解析异常"""
...
class ServiceRegistrationError(InfrastructureException):
    """服务注册异常"""
