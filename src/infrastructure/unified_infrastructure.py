...
class InfrastructureManager:
    ...
    def register_service(self, service_name: str, service_instance, lifecycle: str = "singleton"):
        """注册服务"""
        self._services[service_name] = service_instance
        self._service_lifecycle[service_name] = lifecycle
        return True

    def shutdown(self):
        """关闭基础设施管理器"""
        self._services.clear()
        self._service_lifecycle.clear()
        self._initialized = False
        return True
...
# 兼容性别名 - 为测试提供 UnifiedInfrastructure 类
UnifiedInfrastructure = InfrastructureManager


def get_unified_infrastructure() -> UnifiedInfrastructure:
    """获取统一基础设施管理器（兼容性函数）"""
    return _infrastructure_manager
...
__all__ = [
    ...
    'UnifiedInfrastructure',  # 兼容性别名
    'get_infrastructure_manager',
    'get_unified_infrastructure',  # 兼容性函数
    'get_config_manager',
    'get_monitor',
    'get_cache_manager',
