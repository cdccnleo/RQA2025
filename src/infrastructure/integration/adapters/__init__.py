...
# 导入ServiceConfig
try:
    from src.infrastructure.utils.service_factory import ServiceConfig
except ImportError:
    class ServiceConfig:
        """服务配置占位实现"""
        pass
...
def get_unified_adapter_factory():
    ...
    if _unified_factory_instance is None:
        try:
            ...
            from src.infrastructure.integration.adapters.adapter_lifecycle_wrapper import AdapterLifecycleWrapper
