...
使用方式：
    # 推荐方式（直接使用统一实现）
    from src.infrastructure.integration.unified_business_adapters import get_business_adapter
    
    # 向后兼容方式（通过别名）
    from src.infrastructure.integration.adapters.business_adapters import BusinessLayerType
