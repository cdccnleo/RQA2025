...
class EngineComponentFactory:
    ...
    # 支持的engine ID列表
    SUPPORTED_ENGINE_IDS = [2, 7, 12, 17, 22, 27]
...
def create_engine_engine_component_2(): return EngineComponentFactory.create_component(2)


def create_engine_engine_component_7(): return EngineComponentFactory.create_component(7)


def create_engine_engine_component_12(): return EngineComponentFactory.create_component(12)


def create_engine_engine_component_17(): return EngineComponentFactory.create_component(17)


def create_engine_engine_component_22(): return EngineComponentFactory.create_component(22)


def create_engine_engine_component_27(): return EngineComponentFactory.create_component(27)
