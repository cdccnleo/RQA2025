...
# 统一Watcher组件工厂
    ...
    合并所有watcher_*.py模板文件为统一的管理架误生成时间: 2025 - 08 - 24 10:13:48
"""
...
class WatcherComponentFactory:
    ...
    def get_factory_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "统一Watcher组件工厂，替代原有的模板化文件"
        }

# 向后兼容：创建旧的组件实例


def create_watcher_watcher_component_2():
    return WatcherComponentFactory.create_component(2)


def create_watcher_watcher_component_7():
    return WatcherComponentFactory.create_component(7)
