...
class RepositoryComponentFactory:
    ...
    # 支持的repository ID列表
    SUPPORTED_REPOSITORY_IDS = [4, 8, 12, 16, 20, 24]
...
def create_repository_repository_component_4(): return RepositoryComponentFactory.create_component(4)


def create_repository_repository_component_8(): return RepositoryComponentFactory.create_component(8)


def create_repository_repository_component_12(): return RepositoryComponentFactory.create_component(12)


def create_repository_repository_component_16(): return RepositoryComponentFactory.create_component(16)


def create_repository_repository_component_20(): return RepositoryComponentFactory.create_component(20)


def create_repository_repository_component_24(): return RepositoryComponentFactory.create_component(24)
