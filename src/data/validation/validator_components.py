...
class ValidatorComponentFactory:
    ...
    # 支持的validator ID列表
    SUPPORTED_VALIDATOR_IDS = [1, 6, 11, 16, 21, 26, 31]
...
def create_validator_validator_component_1(): return ValidatorComponentFactory.create_component(1)


def create_validator_validator_component_6(): return ValidatorComponentFactory.create_component(6)


def create_validator_validator_component_11(): return ValidatorComponentFactory.create_component(11)


def create_validator_validator_component_16(): return ValidatorComponentFactory.create_component(16)


def create_validator_validator_component_21(): return ValidatorComponentFactory.create_component(21)


def create_validator_validator_component_26(): return ValidatorComponentFactory.create_component(26)


def create_validator_validator_component_31(): return ValidatorComponentFactory.create_component(31)
