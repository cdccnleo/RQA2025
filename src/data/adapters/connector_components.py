...
class ConnectorComponentFactory:
    ...
    # 支持的connector ID列表
    SUPPORTED_CONNECTOR_IDS = [2, 7, 12, 17, 22, 27]
...
def create_connector_connector_component_2(): return ConnectorComponentFactory.create_component(2)


def create_connector_connector_component_7(): return ConnectorComponentFactory.create_component(7)


def create_connector_connector_component_12(): return ConnectorComponentFactory.create_component(12)


def create_connector_connector_component_17(): return ConnectorComponentFactory.create_component(17)


def create_connector_connector_component_22(): return ConnectorComponentFactory.create_component(22)


def create_connector_connector_component_27(): return ConnectorComponentFactory.create_component(27)
...
__all__ = [
    ...
    "create_connector_connector_component_2",
    "create_connector_connector_component_7",
    "create_connector_connector_component_12",
    "create_connector_connector_component_17",
    "create_connector_connector_component_22",
    "create_connector_connector_component_27",
]
