...
from .web_auth_manager import WebAuthManager
...
class WebManagementService:
    ...
    def __init__(self,
                 ...
                 sync_service: Optional[ConfigSyncService] = None,
        ...
        self._auth_manager = WebAuthManager()
        self._config = web_config or WebConfig()

    def _get_security_service(self) -> SecurityService:
        """获取安全服务实例"""
    ...
    def _get_sync_service(self) -> ConfigSyncService:
        """获取同步服务实例"""
