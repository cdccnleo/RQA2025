...
def test_filter_component_factory_create_component_exception(monkeypatch):
...
def test_filter_component_factory_create_component_initialize_false(monkeypatch):
...
def test_filter_component_factory_create_component_success(monkeypatch):
...
def test_filter_component_factory_create_component_component_none(monkeypatch):
...
def test_filter_component_process_exception(monkeypatch):
    """测试FilterComponent.process的异常处理（104-105行）"""
    component = FilterComponent(filter_id=1)
