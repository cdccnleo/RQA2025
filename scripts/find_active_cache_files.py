...
def find_active_cache_files():
    """查找实际存在的cache_*.py文件（排除备份目录）"""
    print("🔍 查找实际存在的cache_*.py文件...")
    print("="*60)
    ...
    print(f"   📁 发现 {len(cache_files)} 个实际存在的cache_*.py文件")
    ...
    if cache_files:
        ...
        print("   ✅ 没有发现需要处理的cache_*.py文件")

    return cache_files


if __name__ == "__main__":
    find_active_cache_files()
