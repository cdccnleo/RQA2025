...
from src.infrastructure.logging.infrastructure_logger import get_unified_logger
import sys
import json
import ast
...
logger = get_unified_logger('docs_enhancer')
...
class DocsEnhancer:
    ...
    def _extract_api_docs(self, module_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"解析API文档失败: {module_path} - {e}")
            return {}
...
monitor.start_monitoring()
    ...
    def save_documentation(self):
        ...
        logger.info(f"文档已保存到: {self.report_dir}")

    def run(self):
        """运行文档完善流程"""
        logger.info("开始文档完善流程...")
